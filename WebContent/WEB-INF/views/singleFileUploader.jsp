			...
			<div class="row">
				<div class="form-group col-md-12">
					<label class="col-md-3 control-lable" for="file">Upload a
						file</label> <br /> <br /> 
					<label for="textinput1">Video Title: </label>
					<form:input type="text" path="title" />
					<br /> <br /> 
					<label for="textinput2">Video Description: </label><br />
					<form:textarea rows="4" cols="30" path="descr" />
					<br /> <br />
					<div class="col-md-7">
						<form:input type="file" path="file" id="file" accept="video/mp4"
